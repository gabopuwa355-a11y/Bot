...
_TABLE_PK = {
    ...
    "form_table":    "id",
    "referral_bonuses": "id",
    # email sync tables — PK is not 'id'
    "email_cache":   "handle",   # TEXT PRIMARY KEY
    "email_meta":    "k",        # TEXT PRIMARY KEY
    "otp_inbox":     "id",
}
...
def init_db():
    ...
    print("[VERSION] db_pg.py = v6-email-cache-pk-fix-2026-05-12", flush=True)
